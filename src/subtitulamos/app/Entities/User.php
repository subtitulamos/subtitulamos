...
class User
{
    ...
    public function setPasswordWithHash(?string $clearTextPwd)
    {
        if ($clearTextPwd === null) {
            $this->setPassword(''); // Invalid password that disallows account access
        } else {
            $this->setPassword(\password_hash($clearTextPwd, \PASSWORD_BCRYPT, ['cost' => 13]));
        }
    }
